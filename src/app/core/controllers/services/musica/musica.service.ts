...
export class MusicaService {
  ...
  buscarCanciones(valor: string) {
    return this.http.get<queryResponse>(`${environment.API_URL}/search?q=${valor}`, this.options)
  }

  obtenerAlbum(id: string) {
    return this.http.get<Album>(`${environment.API_URL}/album/${id}`, this.options)
  }
